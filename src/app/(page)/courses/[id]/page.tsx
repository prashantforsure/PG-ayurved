...
export default function RedesignedCourseDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-10 mt-12">
              ...
              <CardContent className="p-8">
                ...
                <div className="flex flex-wrap gap-6 mb-8">
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    {/* Add relevant lesson duration information */}
                  </div>
                  <div className="flex items-center text-gray-600">
                ...
                <div className="space-y-4">
                  {course.lessons.map((lesson, index) => (
                    <div key={lesson.id} className="group">
                      <div 
                        className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-200 transition-all duration-300 cursor-pointer"
