...
const ManageUsers = () => {
  ...
  if (!session?.user?.isAdmin) {
    return (
      <div className="flex justify-center items-center h-screen text-2xl font-bold text-gray-800">
        Access Denied
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-50 min-h-screen mt-12">
      <h1 className="text-4xl font-bold mb-8 text-gray-900">Manage Users</h1>

      <Card className="mb-8 border border-gray-300 rounded-lg shadow-md overflow-hidden">
      ...
      <Card className="border border-gray-300 rounded-lg shadow-md overflow-hidden">
        <CardHeader className="bg-white border-b border-gray-300">
          <CardTitle className="text-xl font-semibold text-gray-800">
            User List
          </CardTitle>
